...
Tool output is limited to 24,000 characters. Oversized output keeps its prefix and adds a truncation notice with the estimated size. Return fewer rows, or a compact aggregate next. Use REST, SDKs, or extraction exports to persist every full row.
