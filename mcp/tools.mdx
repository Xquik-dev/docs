...
description: "API MCP v2.6.0 tools, scoped catalogs, sandbox contracts, pagination, and compact workflows. See MCP tools reference examples."
...
See [Read Data Richness](/guides/read-data-richness) for the REST field map.
