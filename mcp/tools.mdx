...
Response schemas can exceed the 24,000-character output limit after reference resolution.
Inspect specific response properties in a separate `search` call.
The limit bounds tool output, not the catalog or available results.
