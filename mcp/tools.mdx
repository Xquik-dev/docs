...
Xquik API MCP v2.6.39 exposes documentation search and 118 JSON or text routes through 3 tools. `docs` searches public docs. `search` searches OpenAPI. `execute` runs authenticated calls. Active guest `paid_reads` keys see exactly 33 GET routes.
