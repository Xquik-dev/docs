...
Use `https://xquik.com/mcp` for Code Mode. Choose native mode for one tool per
operation. Binary downloads and credential lifecycle operations remain REST-only.
