...
<CardGroup cols={2}>
  <Card title="explore" icon="search">
    Search the API spec. Read-only, no network calls, free.
  </Card>
...
| **Model** | 2 tools (`explore` + `xquik`) with code-execution sandbox | 120 individual operations |
...
<CardGroup cols={3}>
  ...
  <Card title="Google ADK" icon="robot" href="/guides/google-adk">Multi-agent assistants with Google ADK</Card>
  <Card title="Mastra" icon="server" href="/guides/mastra">TypeScript agents with Mastra</Card>
  <Card title="Microsoft Agent Framework" icon="microsoft" href="/guides/microsoft-agent-framework">Python agents with Microsoft Agent Framework</Card>
