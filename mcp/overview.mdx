...
See [MCP tools](/mcp/tools) for schemas, retries, timeouts, and response normalization.

### MCP operation boundary

The REST contract documents 131 operations. Full credentials expose 118 JSON or text routes. These 13 stay outside:

- Search public documentation through direct NLWeb routes
...
<CardGroup cols={2}>
  ...
  <Card title="REST API" icon="route">
    Use REST for services, scripts, guest wallets, and downloads. It documents all 131 operations.
  </Card>
</CardGroup>
...
The [Xquik Skill](https://github.com/Xquik-dev/x-twitter-scraper) teaches agents Xquik API, webhook & MCP workflows.

It supports Claude Code, Cursor, Copilot, Codex, Windsurf & Gemini CLI. It covers 131 REST operations.
