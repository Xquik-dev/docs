...
description: Connect AI agents to Xquik API MCP v2.5.5 with OAuth 2.1 over Streamable HTTP
...
Xquik API MCP v2.5.5 exposes a scoped REST catalog through 2 [Model Context Protocol](https://modelcontextprotocol.io) tools. Full credentials see 119 catalog routes. Of these, 118 return JSON or text through MCP. Private support media downloads use REST. Guest `paid_reads` keys see exactly 33 GET routes.
...
<CardGroup cols={2}>
  ...
  <Card title="Server version" icon="badge-check">
    Current API MCP server version: `2.5.5`.
  </Card>
