...
<CardGroup cols={2}>
  ...
  <Card title="API MCP" icon="terminal">
    Use API MCP v2.5.5 at `https://xquik.com/mcp` for live calls. Full account
    keys and OAuth tokens expose 119 catalog routes. Guest `paid_reads` keys
    expose exactly 33 eligible GET routes.
  </Card>
