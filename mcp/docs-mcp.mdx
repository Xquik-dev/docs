---
title: Docs MCP server | MCP Integration Guide
sidebarTitle: "Docs MCP server"
description: "Search public Xquik documentation from AI tools through the Docs MCP server. Review examples, responses, and integration guidance."
...
<CardGroup cols={2}>
  ...
  <Card title="API MCP Server" icon="terminal">
    ...
    eligible GET routes. API MCP v2.6.0 supports MCP `2026-07-28` over
    Streamable HTTP.
  </Card>
</CardGroup>
