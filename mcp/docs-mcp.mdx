...
<CardGroup cols={2}>
  ...
  <Card title="API MCP Server" icon="terminal">
    Interact with X data at `https://xquik.com/mcp`. Use an API key or OAuth 2.1. `explore` searches 118 operations, and `xquik` executes authenticated calls; costs follow the endpoint.
  </Card>
</CardGroup>
