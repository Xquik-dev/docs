---
title: "TypeScript Types for X API Requests"
sidebarTitle: "Type definitions"
description: "Use TypeScript definitions for tweets, profiles, followers, monitors, webhooks, extractions, write actions, pagination, and API errors."
...
<Info>
  ...
  `xquik-api-contract: 2026-04-29`. API MCP v2.6.0 sends that contract
  ...
  `after` for draws, extractions, events, and Radar. Use `afterCursor` for
