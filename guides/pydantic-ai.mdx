---
title: "Pydantic AI Integration for X API"
sidebarTitle: "Pydantic AI"
description: "Connect Pydantic AI agents to tweet search, profile lookup, follower export, monitors, webhooks, and X account actions through MCP."
