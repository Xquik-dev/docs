...
Build a Pydantic AI agent that can search tweets, hand off IDs and cursors, post tweets, and run extraction jobs - connected to Xquik's MCP server with 3 lines of config.
