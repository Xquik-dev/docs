...
description: "Define tweets, profiles, followers, following, replies, monitors, events, webhooks, extractions, cursors, credits, and API contracts. Follow exact steps."
