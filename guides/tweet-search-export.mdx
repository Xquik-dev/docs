...
<Note>
  **Related:** [Extraction workflow](/guides/extraction-workflow) &middot; [Create extraction](/api-reference/extractions/create) &middot; [Search tweets](/api-reference/x/search-tweets)
</Note>
