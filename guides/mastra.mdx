...
sidebarTitle: "Mastra"
description: "Build a Mastra TypeScript agent that searches tweets, looks up profiles, exports followers, monitors keywords, and calls approved X actions. Follow exact steps."
