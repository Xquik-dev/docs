---
title: "Pipedream Integration for X API"
sidebarTitle: "Pipedream"
description: "Build Pipedream components for tweet search, follower exports, extraction polling, account monitor sources, webhooks, and X account actions."
