---
title: "Google ADK X API Guide for Tweet Search & Agents"
sidebarTitle: "Google ADK"
description: "Build Google ADK agents that search tweets, inspect profiles, export followers, monitor keywords, and draft approved X account actions. Follow exact steps."
