---
title: Workflows
description: X API workflow guides for tweet monitoring, signed webhooks, MCP agents, follower exports, and tweet composition.
keywords: ["X API workflows", "Twitter API workflows", "tweet monitoring", "signed webhooks", "follower exports", "MCP agents", "tweet composition"]
---
...
Use these X API workflows to wire Xquik into monitoring dashboards, webhook pipelines, AI agents, data exports, and content tools. Each integration pattern includes copy-ready code in 4 languages.
