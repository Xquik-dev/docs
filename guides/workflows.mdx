...
description: "Workflow finder for X tweet lookup, search, monitoring, webhooks, MCP, exports, DMs. See Workflows examples and guidance."
...
<AccordionGroup>
  <Accordion title="Competitor or brand monitoring">
    ...
    Cost check: active monitors bill 21 credits per hour while enabled.
  </Accordion>
