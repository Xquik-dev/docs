---
title: Haystack
description: Use Xquik Haystack components to retrieve public X posts as Haystack Documents for RAG and agent pipelines
...
| `meta.author` | Author `id`, `username`, `name`, `verified`, and `profilePicture` fields when present |
...
- [Get User Tweets API](/api-reference/x/user-tweets)
