---
title: "Haystack Integration for X API"
sidebarTitle: "Haystack"
description: "Retrieve public tweets as Haystack Documents with text, author, timestamps, metrics, and URLs for RAG, indexing, and agent pipelines."
