...
description: "Build a Twitter data pipeline in Python with Prefect. Search tweets, refresh profiles and timelines, capture trends, paginate results, and retry failures."
keywords: ["Twitter data pipeline Python", "Twitter API Python", "Twitter search pipeline", "tweet search Python", "Prefect", "workflow orchestration", "X API", "Xquik", "pagination", "retries"]
---
...
Use the [`prefect-xquik`](https://github.com/Xquik-dev/prefect-xquik) collection to build an automated Twitter data pipeline in Python. Schedule tweet search, tweet lookup, profile search, or profile lookup. Add timeline refreshes and regional trend checks.
