---
title: "Prefect Integration for X API"
sidebarTitle: "Prefect"
description: Run scheduled Xquik read workflows in Prefect and hand off writes, monitor replays, and extraction jobs to REST, SDKs, or MCP
keywords: ["prefect", "workflow orchestration", "python", "twitter", "x", "xquik", "mcp", "webhooks", "extractions"]
---
