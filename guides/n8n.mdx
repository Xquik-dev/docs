...
### Build an n8n Twitter Bot or Agent

An n8n Twitter bot should never publish unreviewed generated text. Use the n8n
Twitter agent path for searches, profiles, trends, and summaries. Connect the
MCP Client Tool to Xquik through Header Auth.
