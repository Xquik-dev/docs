...
description: Subscription tiers, per-operation credit costs, monitor tweets pricing, credit top-ups, and MPP pay-per-use for the Xquik API
keywords: ["X API pricing", "Twitter API pricing", "subscription", "credits", "monitor tweets pricing", "real-time tweet monitor cost", "tweet alerts cost", "tweet search cost", "follower export cost", "top-up", "MPP pay-per-use"]
---
