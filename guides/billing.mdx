...
Use this table when you need to estimate a real X API task before you run it:
...
| Export followers or follower export | [Follower extraction](/guides/extraction-workflow) or [`GET /x/users/{id}/followers`](/api-reference/x/followers) | 1 credit per follower returned |
| Post tweets or post tweet replies | [Create tweet](/api-reference/x-write/create-tweet) | 10 credits per post tweet call |
| Upload media for tweets or DMs | [Upload media](/api-reference/x-write/upload-media) | 10 credits per media upload call |
| Monitor tweets or send tweet alerts | [Account and keyword monitors](/api-reference/monitors/create) | 21 credits per active monitor-hour, with a 500-credit daily estimate |
| Recover after `402 insufficient_credits` | [`GET /credits`](/api-reference/credits/get), [checkout top-up](/api-reference/credits/topup), or [quick top-up](/api-reference/credits/quick-topup) | Checkout top-ups start at USD 10; quick top-up charges a saved payment method for USD 10-500 |
...
| Keyword monitor slots | Unlimited |
| Active instant monitor hour | 21 credits per active monitor-hour |
| Check interval | 1 second |
| Webhook and event delivery | Included in active monitor billing |
...
|-----------------|-------------|----------------|-----------------------------------------------------------------|
| 1 | 21 credits/hour | 500 credits/day | 22 |
| 5 | 105 credits/hour | 2,500 credits/day | 22 |
| 10 | 210 credits/hour | 5,000 credits/day | 22 |
...
If quick top-up returns `no_payment_method`, create a checkout top-up instead. If it returns `requires_action`, complete the payment confirmation flow before retrying the metered API call.
