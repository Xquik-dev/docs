---
title: "Make X Automation for Tweet Search & Webhooks"
sidebarTitle: "Make"
description: "Build a private Make custom app for Xquik with API-key auth, search, trends, extraction jobs, monitor webhooks, and X actions. Includes exact API steps."
