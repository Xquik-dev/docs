---
title: "Trends"
description: "Trending topics across 12 regions on X with WOEID codes, tweet volumes, and rank positions"
...
The `count` query parameter controls how many trends to return. Defaults to 30, minimum 1, maximum 50.
