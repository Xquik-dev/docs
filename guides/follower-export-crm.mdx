...
Treat `next_cursor` as opaque. Persist every follower page before saving its
...
profile is public before requesting followers. Never infer private profiles
from a missing page. Save each username, user ID, cursor, and
