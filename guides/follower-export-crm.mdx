...
Keep one profile row per stable user ID. Store username, profile name, bio,
location, and verification. Add follower count, following count, profile image,
and source account ID. Keep collection time and extraction ID when returned.
