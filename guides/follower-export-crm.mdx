---
title: "Export Twitter followers to CRM or warehouse"
description: "Export Twitter followers with usernames, profile URLs, bios, counts, and verification. Map CSV, XLSX, or JSON rows into CRM and warehouse fields."
keywords: ["export Twitter followers", "Twitter follower export", "Twitter followers scraper", "follower export", "CRM import", "X followers", "CSV export", "Salesforce upsert", "HubSpot import"]
---
...
Use this workflow to export Twitter followers into a CRM or warehouse. Keep stable user IDs, usernames, profile names, verification, images, and audience counts.
