...
description: "Connect LangChain agents to tweet search, profile lookup, follower export, monitors, webhooks, and X account actions through MCP. Includes exact API steps."
