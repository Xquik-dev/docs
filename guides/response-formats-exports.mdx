...
description: "Choose JSON pages, CSV, JSON, XLSX, Markdown, PDF, or TXT handoffs for Xquik API results, extraction jobs, and draw exports. Includes exact API steps."
keywords:
  [
