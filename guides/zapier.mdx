...
sidebarTitle: "Zapier"
description: "Build a private Zapier integration for tweet search, follower exports, extraction polling, account monitors, REST Hooks, and X actions. Follow exact steps."
