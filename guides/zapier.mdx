---
title: "Zapier X Automation Guide"
description: "Build a private Zapier integration for tweet search, follower exports, extraction polling, account monitors, REST Hooks, and X actions."
...
This gives Zapier builders API-key auth, 128 REST operations, monitor webhooks, extraction jobs, and agent workflows. The visible Zapier X templates focus on polling a query and taking one write action.
