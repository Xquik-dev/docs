...
```bash
openclaw plugins install @xquik/tweetclaw@1.6.28 --pin
```

`@xquik/tweetclaw` is the official package. The plugin id is `tweetclaw`. The current source-truth version is `1.6.28`.
