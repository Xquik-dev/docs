---
title: "Platform architecture | X API workflow guide"
sidebarTitle: "Platform architecture"
description: "Learn how Xquik searches tweets, exports followers, monitors accounts, signs webhooks, isolates accounts, and enforces API rate limits. Follow exact steps."
...
<CardGroup cols={2}>
  <Card title="REST API" icon="braces">
    128 documented operations at `https://xquik.com/api/v1/*` for apps,
...
<CardGroup cols={2}>
  ...
  <Card title="One-time display" icon="shield-check">
    Xquik returns the full key only during creation. Store it securely.
  </Card>
