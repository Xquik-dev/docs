...
| Component | Role |
|-----------|------|
| **REST API** | 118 documented operations at `https://xquik.com/api/v1/*` for programmatic access |
...
| Aspect | Detail |
|--------|--------|
| **Event types** | `tweet.new`, `tweet.reply`, `tweet.quote`, `tweet.retweet` |
...
| **Timeout** | We recommend webhook endpoints respond with `2xx` within 10 seconds |
...
| **Monitor slots** | Unlimited. Active instant monitors cost 21 credits per hour while enabled |
