---
title: "Hermes Tweet for Hermes Agent | Tweet Guide"
sidebarTitle: "Hermes Tweet"
description: "Install Hermes Tweet to search tweets, inspect profiles, export followers, monitor X accounts, and run approved actions from Hermes Agent. Follow exact steps."
keywords: ["hermes tweet", "hermes agent plugin", "tweet search", "x api alternative", "twitter follower export"]
---
