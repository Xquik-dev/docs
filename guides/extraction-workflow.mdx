---
title: "Extraction workflow | X API Workflow Guide"
...
<CardGroup cols={2}>
  <Card title="1. Check credits" icon="credit-card" href="/api-reference/account/get">
    Call `GET /account` to confirm available credits and plan status.
  </Card>
  <Card title="2. Estimate cost" icon="calculator" href="/api-reference/extractions/twitter-scraping-cost-estimator">
  ...
  <Card title="4. Retrieve JSON" icon="rows-3" href="/api-reference/extractions/twitter-extraction-results">
