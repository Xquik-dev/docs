...
back as `after`. Do not mix REST cursors with extraction cursors.
...
Do not rename fields across REST, SDK, MCP, or Actor surfaces.
...
growth analysis. Join snapshots through the profile `id`.
