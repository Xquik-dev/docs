---
title: Tweet, Profile, Media & Reply Fields
description: "Understand complete normalized tweet, profile, media, and reply fields across REST, SDK, MCP, and Actor reads. See examples."
keywords:
  [
    "X API fields",
    "Twitter API fields",
