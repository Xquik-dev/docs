...
const REQUIRED_RULE_SNIPPETS = [
  ...
  '127 documented REST operations',
  '33 prepaid paid-read GET routes',
  '7 fixed-price direct MPP operations',
  '118 or 120 REST operations',
  '118 full-scope MCP operations',
  '31 or 32 MPP read endpoints',
  '119 full-scope MCP catalog routes',
  '118 MCP-compatible JSON or text operations',
  'sdks/',
  'mcp/',
