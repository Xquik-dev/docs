...
const REQUIRED_RULE_SNIPPETS = [
  ...
  '118, 120, or 127 REST operations',
  '118 or 119 full-scope MCP operations',
  '127 REST operations',
  '119 full-scope MCP operations',
  '31 or 32 MPP read endpoints',
  '120 full-scope MCP catalog routes',
  '119 MCP-compatible JSON or text operations',
  'sdks/',
  'mcp/',
  ...
  'Claude Code, OpenCode, Gemini CLI, Cursor, GitHub Copilot CLI, Cline, and Qwen Code support Xquik OAuth',
  'Affected Codex and Goose releases require an environment-backed API key',
  'Roo Code is archived and API-key only',
  'Pi has no native MCP client',
  'Codex or Goose reports',
