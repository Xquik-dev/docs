...
description: "Authorize MCP clients with OAuth 2.1, PKCE, CIMD, and dynamic client registration. Follow token, redirect, discovery, and refresh examples. See examples."
