...
<ParamField query="excludeWords" type="string">
  Words or quoted phrases to exclude from returned tweets. Provide a
  space-delimited, comma-delimited, or multiline list.
</ParamField>

<ParamField query="anyWords" type="string">
  Words or quoted phrases where at least 1 term must appear. Provide a
  space-delimited, comma-delimited, or multiline list.
</ParamField>

<ParamField query="hashtags" type="string">
  Only include tweets matching these hashtags. Provide a space-delimited,
  comma-delimited, or multiline list. The `#` prefix is optional.
</ParamField>

<ParamField query="cashtags" type="string">
  Only include tweets matching these cashtags. Provide a space-delimited,
  comma-delimited, or multiline list. The `$` prefix is optional.
</ParamField>
