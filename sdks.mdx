...
<CardGroup cols={2}>
  ...
  <Card title="Post media tweets or replies" icon="image">
    ...
    Store `tweetId`, `reply_to_tweet_id`, `chargedCredits`, or `writeActionId`. Cost: 10 credits text-only, plus 2 credits per started MB across attached media.
  </Card>
