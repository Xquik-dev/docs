...
const REQUIRED_OPERATIONAL_CONTENT = [
  ...
  },
  {
    ...
    snippets: [
      ...
      'Admins and moderators remain responsible for enforcing Community rules.',
      'There is no separate community account in this contract.',
      'Twitter Communities offer a focused place for shared topics.',
