---
title: "Twitter Webhooks & Notifications API"
sidebarTitle: "Webhooks overview"
description: "Deliver account and keyword monitor events to HTTPS endpoints with signed payloads, event filters, retry schedules, and HMAC verification."
keywords: ["webhook Twitter", "Twitter notifications API", "tweet webhook", "X webhooks", "monitor events", "event delivery", "HMAC", "retry policy"]
---
...
Webhook events are delivered as HTTPS POST requests. Each monitor event is sent
...
## Tweet, follower & profile event shapes
