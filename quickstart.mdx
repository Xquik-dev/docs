...
Set up the API key, verify account access, start a 1-second account monitor, and optionally register a signed webhook endpoint. After this guide you can call the same tasks from REST, SDKs, MCP, or automation tools.
