...
Xquik requires an active subscription ($20/month) to access the API. Subscribe from the dashboard billing page. Your plan includes 1 monitor and a $10/month usage cap.
...
<Warning>
  Store your API key securely. It cannot be retrieved after creation — only revoked and replaced.
</Warning>
