...
const REQUIRED_MASTRA_GUIDE_SNIPPETS = [
  ...
  'This Mastra AI tutorial provides typed examples.',
...
const REQUIRED_N8N_GUIDE_SNIPPETS = [
  ...
  'n8n includes a built-in X node for supported tweets, lists, users, and DMs.',
  '## Match n8n Twitter Automation to the Job',
  'An n8n Twitter scraper should use documented endpoints, not page selectors.',
  'Build an n8n Twitter monitoring workflow with account or keyword monitors.',
  'An n8n Twitter media upload uses different inputs by action.',
  '### Build an n8n Twitter Bot and n8n Twitter Agent',
  'An n8n Twitter bot should never publish unreviewed generated text.',
  'the MCP Client Tool to integrate AI agents with Xquik.',
  'Share reusable templates through the n8n community.',
  'Use custom code nodes only for signature verification or bounded transforms.',
