...
const REQUIRED_TYPESCRIPT_SDK_WORKFLOW_SNIPPETS = [
  ...
  'The generated TypeScript SDK models confirmed `tweetId` responses.',
...
const REQUIRED_MCP_CONTRACT_SNIPPETS = [
  ...
  'REST and generated SDK pages may show camelCase fields such as `tweetId`, `writeActionId`, `mediaId`, and `messageId`; keep MCP agents on snake_case when reading tool results.',
...
const REQUIRED_ZAPIER_GUIDE_SNIPPETS = [
  ...
  'For `202 x_write_unconfirmed`, return `writeActionId`, `status`, and `charged`, then poll `GET /x/write-actions/{id}` before retrying.',
...
const REQUIRED_PIPEDREAM_GUIDE_SNIPPETS = [
  ...
  '<Card title="Tweet or reply write" icon="send">',
  'For `202 x_write_unconfirmed`, export `writeActionId`, `status`, and `charged`, then poll `GET /x/write-actions/{id}` before retrying.',
  '<Card title="Public media upload" icon="image">',
...
const REQUIRED_N8N_GUIDE_SNIPPETS = [
  ...
  '<Card title="Tweet or reply write" icon="send">',
  'For `202 x_write_unconfirmed`, store `writeActionId`, `status`, and `charged`, then poll `GET /x/write-actions/{id}` before retrying.',
  '<Card title="Public media upload" icon="image">',
...
const REQUIRED_MAKE_GUIDE_SNIPPETS = [
  ...
  '<Card title="Tweet or reply write" icon="send">',
  'For `202 x_write_unconfirmed`, store `writeActionId`, `status`, `charged`, and poll `GET /x/write-actions/{id}` before retrying.',
  '<Card title="Public media upload" icon="image">',
