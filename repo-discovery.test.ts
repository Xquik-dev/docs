...
const REQUIRED_CREATE_TWEET_API_SNIPPETS = [
  ...
  'Send up to 4 JPEG, PNG, GIF, WebP, or AVIF image URLs, or exactly 1 MP4 video URL.',
  ...
  'Send up to 4 image URLs or exactly 1 MP4 video URL.',
...
const REQUIRED_MEDIA_UPLOAD_WORKFLOW_SNIPPETS = [
  ...
  'Send up to 4 images or exactly 1 MP4 video.',
  ...
  'POST /x/dm/{userId}',
  '`media_ids`',
  'For tweet-only workflows with already public image URLs or exactly 1 public MP4 video URL, call `POST /x/tweets` directly with `media`.',
