...
const REQUIRED_COMPOSIO_MIGRATION_SNIPPETS = [
  ...
  'Composio AI is an integration platform for AI assistants.',
  'pre-built tools and handles OAuth',
  'When asking what is Composio AI, separate authorization, tool transport, and execution.',
  'Compare alternatives to Composio using the exact Twitter workflow being replaced.',
  'This guide compares AI workflow tools for X tasks.',
  'It does not rank general enterprise AI automation platforms.',
  'Platforms for building custom AI agents still need X authorization.',
  'They also need stable tweet fields and retry rules.',
  'Choose an AI-powered workflow builder only after checking those contracts.',
  'Open-source AI agent development changes orchestration, not the Xquik API contract.',
  ...
  'Record each tool call. List API calls, API endpoints, and side effects.',
  'Choose unified APIs for cross-app actions.',
  'Choose a direct REST API for explicit X contracts.',
  'Never confuse an application user with an X user profile.',
  'Verify retries, audit records, API documentation, and production-ready rollback steps.',
  'Do not choose an automation tool by its free tier alone.',
  'Record any white-label login or consent requirements.',
  'Do not promise real time results without measuring each route.',
  'A data sync must name the tweets, profiles, followers, or events it mirrors.',
  'Compare Twitter automation tools by supported reads, exports, monitors, webhooks, and approved writes.',
