...
const REQUIRED_MCP_CONTRACT_SNIPPETS = [
  ...
  'Write and media results also use the MCP-normalized snake_case contract.',
  'Read `tweet_id`, `write_action_id`, `charged_credits`, `media_id`, `media_url`, and `message_id` from `response.result`.',
