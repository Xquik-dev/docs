...
const REQUIRED_DIRECT_MESSAGE_WORKFLOW_SNIPPETS = [
  ...
  'Provide an easy opt-out for automated message workflows.',
] as const;
...
const REQUIRED_CAMPAIGN_VERIFICATION_WORKFLOW_SNIPPETS = [
  ...
  '`POST /api/v1/draws`',
  'Use one reviewable draw as a Twitter giveaway winner picker.',
  'hashtag checks for a Twitter hashtag giveaway picker.',
  'choosing winners from retweets.',
  'This Twitter picker stores source Tweet IDs,',
  'It also stores timestamps and public',
...
const REQUIRED_MASTRA_GUIDE_SNIPPETS = [
  ...
  '### What Makes a Robust Twitter Agent System?',
