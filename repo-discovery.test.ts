...
const REQUIRED_PYDANTIC_AI_GUIDE_SNIPPETS = [
  ...
  'This Pydantic AI MCP server connection uses the Xquik HTTPS URL.',
  ...
  'The `import asyncio` statement enables the asynchronous entry point.',
...
const REQUIRED_LANGCHAIN_GUIDE_SNIPPETS = [
  ...
  'Every API call follows the documented Xquik route',
  ...
  'Your model provider may require an OpenAI API key',
