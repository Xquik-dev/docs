...
const REQUIRED_PREFECT_GUIDE_SNIPPETS = [
  ...
  'This Prefect Python library provides typed credentials and six read-only tasks.',
  'Prefect turns Python functions into observable data pipelines.',
  ...
  'PyPI publishes `prefect-xquik` 0.1.8 and earlier releases, including 0.1.7.',
