...
const REQUIRED_KEYWORD_MONITOR_API_HANDOFF_SNIPPETS = [
  ...
  'webhook payloads.',
  '<Card title="Event Filter" icon="funnel">',
  'create the webhook with matching event types',
  'receiver wants a subset',
  ...
  'Store the one-time webhook `secret`',
  'run `POST /webhooks/{id}/test`',
  '`X-Xquik-Signature`, `X-Xquik-Timestamp`, and `X-Xquik-Nonce`',
  'Use `deliveryId` for receiver idempotency and `streamEventId` plus',
  '`keywordMonitorId`',
  'GET /events/{id}',
