...
const REQUIRED_WORKFLOW_OVERVIEW_SNIPPETS = [
  ...
  '### 4. Upload media before posting tweets',
  '`POST /x/media`, then `POST /x/tweets`',
  'one-item DM `media_ids` arrays',
  '`mediaUrl`, `mediaId`, `tweetId`, and `success`',
  '10 credits per media upload call plus 10 credits per post tweet call',
