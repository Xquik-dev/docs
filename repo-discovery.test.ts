...
const REQUIRED_ZAPIER_GUIDE_SNIPPETS = [
  ...
  'Use a Zapier Twitter Google Sheets workflow for searchable tweet rows.',
  'Use Zapier Twitter to Slack for verified alerts in real time.',
  'Choose Zapier Twitter Discord for matched tweet notifications.',
  'Build Zapier RSS to Twitter flows from blog posts and an RSS feed.',
  'Review scheduled tweets and the Twitter account before scheduling posts.',
  'Every Zapier post to Twitter step needs approval and an idempotency key.',
  'Keep each automated workflow focused on one search, monitor, export, or write.',
  ...
  'Keep approval before publishing or scheduling posts.',
