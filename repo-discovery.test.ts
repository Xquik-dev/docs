...
const REQUIRED_README_SNIPPETS = [
  ...
  '[MCP server v2.6.34](https://docs.xquik.com/mcp)',
...
const REQUIRED_MCP_CONTRACT_SNIPPETS = [
  ...
  'Use `GET /api/v1/x/tweets/search` for 20 Tweet rows or fewer, including exactly 20.',
  'A count alone never requests an extraction.',
  'has_more',
  'next_cursor',
  ...
  'API MCP v2.6.34 sends that contract',
...
const REQUIRED_DOCS_MCP_SERVER_SNIPPETS = [
  ...
  'Full credentials search 118 catalog routes. Guest `paid_reads` keys search 33',
