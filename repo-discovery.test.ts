...
const REQUIRED_COMMUNITY_SEARCH_API_HANDOFF_SNIPPETS = [
  ...
  '[`GET /x/communities/tweets`](/api-reference/x/search-community-tweets)',
  'same `q`, `queryType`, and `cursor` shape.',
  '<Card title="Known community posts" icon="message-square-text">',
  '[`GET /x/communities/{id}/tweets`](/api-reference/x/community-tweets)',
  '<Card title="Bulk community jobs" icon="file-spreadsheet">',
  '`community_search` or `community_post_extractor`',
...
const REQUIRED_TWEET_SEARCH_EXPORT_SNIPPETS = [
  ...
  'For strict account date windows',
  'optimized for account timeline completeness',
...
const REQUIRED_SEARCH_TWEETS_API_HANDOFF_SNIPPETS = [
  ...
  '`GET /x/users/{id}/tweets`',
  'A strict account date window such as',
  ...
  'For account date windows, `q=from:username` with `sinceTime` or',
  '`untilTime` favors account timeline completeness',
  'ranked search',
