...
const REQUIRED_SEARCH_TWEETS_API_HANDOFF_SNIPPETS = [
  ...
  '## Direct API handoff',
  '`GET /x/tweets/search`',
  'for live, paginated JSON.',
  'Store stable IDs, requested',
  'fields, and `next_cursor` so workers can resume.',
  'saved result pages, or downloadable CSV, JSON, and XLSX files.',
...
const REQUIRED_TWEET_PROFILE_API_FIELDS_SNIPPETS = [
  ...
  '## Tweet fields',
  '- Quote: `isQuoteStatus`, `quoted_tweet`, and `quotedTweetId`',
  '- Publishing client: `source`',
  '- Repost and long-form context: `retweeted_tweet` and `isNoteTweet`',
  '- Engagement: `retweetCount`, `replyCount`, `likeCount`, `quoteCount`, `viewCount`, and `bookmarkCount`',
