...
description: "Compare SocialCrawl with Xquik for tweet search, follower exports, tweet and reply posting, monitors, webhooks, API access, and MCP."
...
Current public SocialCrawl surfaces use different coverage counts: the docs introduction says 21 platforms and 108 endpoints, while the pricing page says 27 platforms and 133 APIs.
...
<CardGroup cols={3}>
  ...
  <Card title="Setup & API" icon="square-terminal">
    Agent fit: Skills and MCP packages for broad social collection. Xquik:
    MCP and REST tools for tweet search, profile lookup, follower or reply
