...
| Coverage | Analytics, tweet metrics, engagement tracking, past interactions, private notes, reminders, reply search, quick reply, scheduling, browser extensions, mobile apps, and reports. | 47 dashboard tools, 126 REST operations, 23 extraction tools, 17 X write actions, account and keyword monitors, webhooks, giveaway draws, Radar, 10 SDKs, MCP, and pay-per-use reads. |
