...
Black Magic's official home positions the product around Twitter analytics, engagement growth, Twitter CRM, and scheduling plus publishing. It lists browser extensions for Chrome, Firefox, and Safari plus iOS and Android apps.
...
The relationship and CRM section says Black Magic can sync Twitter Lists, track whether a person liked, retweeted, or replied to previous tweets, write private notes, set reminders for DMs or follow-up, see past interactions, and organize tweets into categories.
...
| Schedule tweets and threads | Personal does not list schedule tweets or schedule threads; Professional and Business include them. | Xquik create-tweet actions cost 30 credits per tweet or reply, and media uploads cost 10 credits per upload call. |
...
| Coverage | Analytics, tweet metrics, engagement tracking, past interactions, private notes, reminders, reply search, quick reply, scheduling, browser extensions, mobile apps, and reports. | 47 dashboard tools, 128 REST operations, 23 extraction tools, 17 X write actions, account and keyword monitors, webhooks, giveaway draws, Radar, 10 SDKs, MCP, and pay-per-use reads. |
...
<CardGroup cols={3}>
  <Card title="Use when" icon="route">
    Core focus: Creator relationships, audience context, and tweet performance.
    Xquik: Tweet search, profile lookup, follower and reply exports, timelines,
...
Do not compare relationship context with raw row volume. Compare support for the intended decision and evidence handoff.

The tools may work together. Keep Black Magic for relationship context. Keep Xquik for structured X workflows.
