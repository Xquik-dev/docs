...
<Info>
  This is a factual comparison and migration guide. "Twitter API Pro" is a legacy comparison term. Verify current X API pricing, access rules, and product terms on the [official pricing page](https://docs.x.com/x-api/getting-started/pricing) before buying.
</Info>
