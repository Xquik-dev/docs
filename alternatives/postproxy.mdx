...
<CardGroup cols={3}>
  <Card title="Use when" icon="route">
    Postproxy covers multi-platform publishing through one social API. Xquik covers tweet search, follower exports, media posts & account monitors, publishing, monitors, and exports.
  </Card>
