...
| Coverage | Create and manage social posts, profile groups, queues, comments, analytics, publish logs, webhooks, media URLs, MCP, skills, workflow tools, and publishing retries across supported platforms. | 47 dashboard tools, 118 REST operations, 23 extraction tools, 17 X write actions, account and keyword monitors, webhooks, giveaway draws, Radar, 10 SDKs, MCP, and pay-per-use reads. |
