...
<CardGroup cols={2}>
  <Card title="X Tweet Scraper" icon="store" href="https://apify.com/xquik/x-tweet-scraper">
    Apify lists this Actor with a Rising star badge. It extracts tweets, engagement metrics, author profiles, and media, then writes rows to an Apify dataset.
  </Card>
...
<Note>
  Store rankings change. During this update, Apify Store API relevance search for `x tweet scraper` returned `xquik/x-tweet-scraper` at rank 5 with a Rising star badge, and returned `xquik/x-follower-scraper` at rank 7.
</Note>
