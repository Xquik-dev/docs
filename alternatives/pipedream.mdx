---
title: "Pipedream Alternative for X Workflows"
sidebarTitle: "Pipedream"
description: "Compare Pipedream with Xquik for X/Twitter automation, tweet search, follower exports, webhooks, APIs, MCP, and workflow handoffs."
...
<CardGroup cols={2}>
  ...
  <Card title="Reusable Xquik action" icon="/logo/x-only.svg">
