...
<CardGroup cols={3}>
  <Card title="Use when" icon="route">
    TweetDeck covers browser columns, Decks, advanced search, and post composer. Xquik covers tools dashboard plus API calls.
  </Card>
  ...
  <Card title="Output" icon="download">
    TweetDeck covers native X dashboard workflow. Xquik covers automated extraction, write actions, and monitoring.
  </Card>
</CardGroup>
