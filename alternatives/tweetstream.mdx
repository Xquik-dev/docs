...
<CardGroup cols={3}>
  <Card title="Use when" icon="route">
    TweetStream covers WebSocket envelopes, enrichment metadata, account events, and replay rows. Xquik covers REST responses, extractions, exports, and webhook events.
  </Card>
