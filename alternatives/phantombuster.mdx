...
<CardGroup cols={3}>
  <Card title="Setup" icon="route">
    PhantomBuster lets teams choose a Phantom or Flow and configure account/session inputs. Xquik lets teams create an API key or use a dashboard tool for the X task.
  </Card>
  <Card title="Output" icon="download">
    PhantomBuster lets teams download or chain result files. Xquik lets teams receive API responses, exports, monitor events, webhook payloads, or MCP tool output.
  </Card>
  <Card title="Handoff" icon="workflow">
    PhantomBuster lets teams chain Phantoms or export files. Xquik lets teams call REST, poll events, receive signed webhooks, export files, use SDKs, or use MCP.
  </Card>
</CardGroup>
