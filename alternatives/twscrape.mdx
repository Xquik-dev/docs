...
| Coverage | twscrape README covers Search and GraphQL access, account sessions, raw or SNScrape-shaped responses, search/tweet/user/list/trend calls, and account switching for rate-limit smoothing. | 47 dashboard tools, 126 REST operations, 23 extraction tools, 17 X write actions, account and keyword monitors, webhooks, giveaway draws, Radar, 10 SDKs, MCP, and pay-per-use reads. |
