...
<Info>
  Verify current twscrape pricing, access rules, and product terms on the official site before buying.
</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="Setup & API" icon="square-terminal">
    With twscrape, teams own retries, storage, exports, and uptime. Xquik handles exports, uptime, and support.
  </Card>
