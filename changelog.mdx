...
keywords: ["Xquik changelog", "Xquik documentation updates", "Twitter API changelog", "scraper API updates"]
---
...
Follow Xquik documentation updates for tweet search, follower exports, monitors,
webhooks, and SDKs. Track API keys and signed webhook deliveries. Search tweets
and review user profile updates. Use this Xquik changelog to review REST, MCP,
authentication, billing, and write changes.
...
<Update label="August 2026" description="v1">
  **New**
  ...
  - OAuth discovery advertises claimed `service_auth` agent registration
  - Claimed agents receive access tokens and identity assertions after approval
