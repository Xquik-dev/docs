...
Use the C# SDK for typed .NET Standard 2.0+ access from services, workers, console tools, and ASP.NET backends. A .NET job can search or scrape tweets, export followers, monitor tweets, post media, send direct messages, or hand X API data to queues, CRMs, and reports.
