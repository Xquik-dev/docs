...
Use Kotlin for nullable models, builders, sync/async calls, and JVM workers. Build locally until Maven Central publication. Use Java for Java services or C# for .NET.
