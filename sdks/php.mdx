...
title: PHP SDK
sidebarTitle: PHP
description: Use the Xquik PHP SDK to search tweets, export tweet replies to JSON Lines, CSV, or XLSX, post image tweets, upload media, send DMs, and run PHP X API workers.
