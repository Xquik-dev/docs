---
title: "PHP SDK for Twitter API"
sidebarTitle: PHP
description: Use Xquik's PHP SDK to search tweets, export replies to JSON Lines, CSV, or XLSX, post media tweets, upload media, send DMs, and run X API workers.
...
Choose PHP for Composer installation, PHP 8.1+, named parameters, and typed exceptions. It fits Laravel commands, Symfony consoles, cron jobs, and PHP workers. Use Ruby when the application and deployment stack are Ruby-based.
