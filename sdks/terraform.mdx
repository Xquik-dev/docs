...
<CardGroup cols={2}>
  ...
  <Card title="Media boundary" icon="image">
    The `media` argument is for public image URLs or exactly one public MP4 URL. Do not pass uploaded media IDs to this resource; uploaded media IDs are for direct messages through `POST /x/dm/{userId}`.
  </Card>
</CardGroup>
