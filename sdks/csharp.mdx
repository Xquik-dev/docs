...
title: C# SDK
sidebarTitle: C# / .NET
description: Use the Xquik C# SDK to search tweets, export tweet replies to JSON Lines, CSV, or XLSX, post image tweets, upload media, send DMs, and run .NET X API workers.
