...
| Check | Verify | Failure mode to handle |
| --- | --- | --- |
...
| Ambiguous writes | Treat `202 x_write_unconfirmed` as a manual verification step before retrying. | Duplicate tweets, repeated actions, or inconsistent operator handoff. |
