...
Use quick top-up after the dashboard confirms an amount from USD 10 through
500. This route requires a same-origin Xquik session. External integrations
...
<ResponseField name="outcome" type="string">Always `"declined"`.</ResponseField>
