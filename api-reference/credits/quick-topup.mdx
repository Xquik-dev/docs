...
description: "Charge a saved payment method for USD 10-500 of tweet, profile, follower, monitor, webhook, export, and X write API credits. Includes response fields."
