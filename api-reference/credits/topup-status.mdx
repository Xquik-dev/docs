---
title: "API credit top-up status & payment check"
sidebarTitle: "Get top-up status"
description: "Poll a credit checkout session for pending, paid, expired, or failed status before starting tweet, follower, monitor, or write requests."
