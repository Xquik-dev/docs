---
title: "Get credits | REST API reference"
sidebarTitle: "Get credits"
description: "Retrieve available API credits, included monthly credits, purchased credits, lifetime usage totals, and automatic top-up settings."
api: "GET /credits"
