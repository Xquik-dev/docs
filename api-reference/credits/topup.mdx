---
title: "Top up credits | REST API reference"
sidebarTitle: "Top up credits"
description: "Get a checkout URL to purchase credits with a minimum of $10. Review parameters, examples, responses, and integration guidance."
