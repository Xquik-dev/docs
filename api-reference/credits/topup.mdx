...
<Tabs>
  <Tab title="200 OK">
    <ResponseField name="url" type="string">Checkout URL. Redirect the user to complete payment.</ResponseField>
    <ResponseField name="redirect_url" type="string">Same checkout redirect URL in snake_case for agent and API handoffs.</ResponseField>

    ```json
    {
      "url": "https://xquik.com/billing/checkout/session",
      "redirect_url": "https://xquik.com/billing/checkout/session"
    }
    ```
  </Tab>
