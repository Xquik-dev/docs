---
title: "Get X account | REST API reference"
sidebarTitle: "Get X account"
description: "Use X account health before writes: healthy writes, recovering is ready, temporaryIssue waits, needsReauth fixes access. See examples."
...
Use this route as a health gate before one connected-account write. Read health, recovery, and credential state before selecting the next action. Use list only for account-wide inventory.
