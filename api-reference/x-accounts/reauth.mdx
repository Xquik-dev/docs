...
<Info>
  Re-authentication does not guarantee the same public IP. Custom or fixed
...
| X user ID | Response `xUserId` | Preserve the stable account identity. |
