...
5. Copy the long secret key and store it safely.
6. Finish enabling 2FA on X by entering the 6-digit code from your authenticator app.
7. Send the new key in `totp_secret`.
