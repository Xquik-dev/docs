...
<ResponseExample>
  ...
  ```json 202 · x-accounts/submit-challenge
  {
  ...
  ```json 400 · x-accounts/submit-challenge
  {
    "error": "invalid_input",
  ...
  ```json 401 · x-accounts/submit-challenge
  {
  ...
  ```json 404 · x-accounts/submit-challenge
  {
    "error": "not_found",
  ...
  ```json 409 · x-accounts/submit-challenge
  {
  ...
  ```json 410 · x-accounts/submit-challenge
  {
  ...
  ```json 422 · x-accounts/submit-challenge
  {
    "error": "login_failed",
  ...
  ```json 429 · x-accounts/submit-challenge
  {
  ...
  ```json 503 · x-accounts/submit-challenge
  {
