---
title: "Twitter giveaway history & past winners"
sidebarTitle: "List draws"
description: "List giveaway draws with source tweets, eligibility rules, winner counts, statuses, creation times, and cursor-based pagination."
api: "GET /draws"
