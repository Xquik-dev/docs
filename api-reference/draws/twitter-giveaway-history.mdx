...
description: "List giveaway draws with source tweets, eligibility rules, winner counts, statuses, creation times, and cursor-based pagination. Includes API examples."
api: "GET /draws"
...
<ResponseExample>
  ...
  ```json 401 · draws/twitter-giveaway-history
  {
  ...
  ```json 429 · draws/twitter-giveaway-history
  {
