---
title: "Export draw | REST API reference"
sidebarTitle: "Export draw"
description: "Export giveaway draw winners and participant rows in 7 formats, including CSV, XLSX, JSON, Markdown, and PDF. See examples and guidance."
