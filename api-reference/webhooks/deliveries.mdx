...
description: "Inspect a webhook's tweet, follower, profile, relationship, or keyword event delivery attempts, HTTP statuses, errors, and retry times. See event fields."
