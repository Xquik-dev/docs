---
title: "Twitter webhook API | list endpoints"
sidebarTitle: "List webhooks"
description: "List registered webhook endpoints with URLs, event filters, active states, failure counts, delivery timestamps, and creation times."
api: "GET /webhooks"
