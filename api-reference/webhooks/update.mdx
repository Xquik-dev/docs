---
title: "Twitter webhook API | update endpoint"
sidebarTitle: "Update webhook"
description: "Change a webhook's HTTPS URL, tweet, follower, profile, relationship, or keyword event filters, and active delivery state."
