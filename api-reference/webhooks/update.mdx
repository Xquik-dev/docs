---
title: "Update webhook | REST API reference"
sidebarTitle: "Update webhook"
description: "Update the URL, event types, or active state of an existing webhook. Review examples, responses, and integration guidance."
