---
title: "Twitter webhook API | resume deliveries"
sidebarTitle: "Resume webhook"
description: "Test and resume a paused webhook after delivery failures. Confirm its HTTPS response before sending new signed monitor events."
