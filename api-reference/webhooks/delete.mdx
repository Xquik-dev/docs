...
description: "Delete a webhook endpoint and stop future tweet, follower, profile, relationship, or keyword monitor event deliveries to its URL. See response fields."
