---
title: "Twitter webhook API | delete endpoint"
sidebarTitle: "Delete webhook"
description: "Delete a webhook endpoint and stop future tweet, follower, profile, relationship, or keyword monitor event deliveries to its URL."
