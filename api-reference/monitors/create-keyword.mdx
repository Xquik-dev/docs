...
description: "Create a 1-second keyword monitor for an X search query. Store matching tweet events and deliver selected events to signed webhooks. See event fields."
api: "POST /monitors/keywords"
keywords: ["Twitter keyword monitor", "track keywords Twitter API", "Twitter mention tracking tool", "monitor Twitter mentions", "monitor tweets", "real-time tweet alerts", "signed webhooks"]
---
...
<ResponseExample>
  ...
  ```json 400 · monitors/create-keyword
  {
    "error": "invalid_input",
  ...
  ```json 401 · monitors/create-keyword
  {
  ...
  ```json 402 · monitors/create-keyword
  {
  ...
  ```json 409 · monitors/create-keyword
  {
  ...
  ```json 429 · monitors/create-keyword
  {
