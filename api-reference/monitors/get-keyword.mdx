---
title: "Get keyword monitor | REST API reference"
sidebarTitle: "Get keyword monitor"
description: "Get one keyword monitor's X query, tracked event types, active state, polling interval, creation time, and latest event checkpoint."
