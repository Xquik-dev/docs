---
title: "Twitter keyword monitor deletion & stopped webhook alerts"
sidebarTitle: Delete keyword monitor
description: "Delete a keyword monitor, stop polling its X search query, and prevent new matching tweet events and webhook deliveries."
