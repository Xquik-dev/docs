...
description: "List account monitors with tracked X profiles, tweet, follower, following, profile, and relationship event types, states, and billing. See event fields."
api: "GET /monitors"
