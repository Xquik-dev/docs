...
Together, these fields form one reproducible monitor snapshot.
...
with the approved change ticket. Reject the update when `xUserId` unexpectedly
changes.
...
schedule. This snapshot becomes the change baseline.
