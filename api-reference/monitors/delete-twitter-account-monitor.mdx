---
title: "Twitter Account Monitor Deletion & Stopped Alerts"
sidebarTitle: "Delete account monitor"
description: "Delete an account monitor, stop tracking tweets, followers, following, profile changes, and relationships, and remove stored events. See event fields."
...
<ResponseExample>
  ...
  ```json 400 · monitors/delete-twitter-account-monitor
  {
    "error": "invalid_input",
  ...
  ```json 401 · monitors/delete-twitter-account-monitor
  {
  ...
  ```json 404 · monitors/delete-twitter-account-monitor
  {
    "error": "not_found",
  ...
  ```json 429 · monitors/delete-twitter-account-monitor
  {
...
| Stored events | `GET /events?monitorId={id}` | Export required tweet events before deletion. |
