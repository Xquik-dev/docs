---
title: "Update monitor | REST API reference"
sidebarTitle: "Update monitor"
description: "Change event types or toggle active status for a monitor. Review parameters, examples, responses, and integration guidance."
