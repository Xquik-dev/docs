...
description: "Monitor one X account every second for tweets, followers, following, profile, or relationship changes and deliver signed webhook events. See event fields."
api: "POST /monitors"
