---
title: "Twitter account monitor API & real-time tweet alerts"
...
Create an account monitor when one profile needs continuous tweet or
relationship checks. Select event types, store the monitor ID, then connect a
signed webhook.
