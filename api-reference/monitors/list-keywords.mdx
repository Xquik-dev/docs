...
description: "List keyword monitors with X search queries, matching tweet event types, active states, polling intervals, billing state, and timestamps. See event fields."
...
<ResponseExample>
  ...
  ```json 401 · monitors/list-keywords
  {
  ...
  ```json 429 · monitors/list-keywords
  {
