...
description: "Retrieve account identity, locale, subscription state, available API credits, monitor billing, automatic top-up settings, and timestamps. See examples."
api: "GET /account"
