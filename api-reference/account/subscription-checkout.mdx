---
title: "Xquik Subscription Checkout & Plan Activation"
sidebarTitle: "Subscription checkout"
description: "Create a hosted subscription checkout or billing portal URL. Start, update, or cancel account access before using API features. Includes API examples."
api: "POST /subscribe"
keywords: ["subscribe", "checkout", "billing", "payment"]
---
...
<ResponseExample>
  ...
  ```json 401 · account/subscription-checkout
  {
  ...
  ```json 429 · account/subscription-checkout
  {
