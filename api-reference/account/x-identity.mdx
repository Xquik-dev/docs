---
title: "Connected X identity & account selection"
sidebarTitle: "Set X identity"
description: "Link an X username to your Xquik account for own-profile detection, owned tweet reads, pricing rules, and account-specific workflows."
