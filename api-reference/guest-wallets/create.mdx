...
description: "Create a USD 10-250 hosted checkout and accountless API key for tweet, profile, follower, reply, timeline, community, and list reads. See safe examples."
...
<ResponseField name="checkout_url" type="string">One-use hosted checkout URL for the user to open.</ResponseField>
...
<ResponseField name="expires_at" type="string">Pending checkout expiry. New checkouts expire after 60 minutes.</ResponseField>
