---
title: "Create guest wallet | REST API reference"
sidebarTitle: "Create guest wallet"
description: "Create a USD 10-250 hosted payment link and accountless API key for tweet, profile, follower, reply, timeline, community, and list reads."
