...
description: "Check a guest API key's activation, credit balance, hosted payment status, and access to tweet, profile, follower, and reply reads. See request fields."
