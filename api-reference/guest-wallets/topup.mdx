---
title: "Top up guest wallet | REST API reference"
sidebarTitle: "Top up guest wallet"
description: "Create a USD 10-250 hosted payment link to add tweet, profile, follower, reply, timeline, community, and list read credits to a guest key."
