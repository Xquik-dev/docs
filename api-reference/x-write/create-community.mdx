---
title: "Create X Community API for Group Setup Workflow"
sidebarTitle: "Create community"
description: "Create an X community under a connected account with an approved name and optional public description, then track the write lifecycle. See action fields."
