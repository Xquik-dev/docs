---
title: "Unretweet"
description: "Remove a retweet of a tweet by ID from a connected X account"
...
<Tabs>
  ...
  <Tab title="500 Write Failed">
    ...
    ```
    The unretweet could not be completed. The tweet may have been deleted, or the connected account may be rate-limited. Try again later.
  </Tab>
</Tabs>

<Note>
  **Related:** [Retweet](/api-reference/x-write/retweet) to retweet a tweet, [Like Tweet](/api-reference/x-write/like) to like a tweet, [Unlike Tweet](/api-reference/x-write/unlike) to remove a like, or [Create Tweet](/api-reference/x-write/create-tweet) to post an original tweet.
</Note>
