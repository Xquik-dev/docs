...
keywords: ["Twitter API errors", "Twitter API error handling", "write action status", "error message", "response codes", "rate limit", "idempotency", "pending write", "safe retry", "billing status", "X write API"]
---
...
X documents separate [response codes and errors](https://docs.x.com/x-api/fundamentals/response-codes-and-errors)
for its API. Those fields differ from Xquik's write status record.
