---
title: "X profile avatar API & image update"
sidebarTitle: "Update avatar"
description: "Upload a new avatar image for a connected X profile. Send supported image bytes and inspect the updated profile image response."
