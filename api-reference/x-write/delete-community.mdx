...
<Tabs>
  ...
  <Tab title="429 Rate Limited">
    ...
    ```
    The request hit an Xquik tier limit, or X throttled the community deletion. Possible codes: `rate_limit_exceeded`, `x_rate_limited`, or `x_daily_limit`. Respect the `Retry-After` header when present.
  </Tab>
