...
A design tool or Twitter header template can export either accepted format.
...
from that source instead of resizing previous uploads. Record the header
dimensions and final file size beside the source. A social media platform
