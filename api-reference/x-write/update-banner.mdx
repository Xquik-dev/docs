...
Accept only JPEG or PNG image formatting. This route does not support animated
GIFs. A design tool or Twitter header template can export either accepted
format. Review every template export before uploading. Read X's
