...
description: "Send an X direct message from a connected account, with optional one-item media_ids attachment"
api: "POST /x/dm/{userId}"
keywords: ["dm", "direct message", "send DM", "Twitter DM API", "X direct message API", "send DM with media", "media_ids", "write", "connected account"]
---
