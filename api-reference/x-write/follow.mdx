...
<Note>
  **Related:** [Unfollow User](/api-reference/x-write/unfollow) to reverse this action, or [Get User](/api-reference/x/get-user) to look up user details before following.
</Note>
