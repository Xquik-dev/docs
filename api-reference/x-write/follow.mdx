...
Confirm the target and approve the acting account before sending the action.
...
`https://xquik.com/api/v1/x/users/{id}/follow`.
...
X may create a pending follow request for a protected profile.
