---
title: "Get users (batch) | REST API reference"
sidebarTitle: "Get users (batch)"
description: "Retrieve up to 100 X user profiles by ID in one request, including usernames, bios, verification state, follower counts, and profile media."
