---
title: "Get community info | REST API reference"
sidebarTitle: "Get community info"
description: "Retrieve details for an X community including name, description, member count, rules, and join policy. See examples and guidance."
