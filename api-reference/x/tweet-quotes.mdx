---
title: "Get quote tweets | REST API reference"
sidebarTitle: "Get quote tweets"
description: "Retrieve quote tweets for one source tweet with authors, text, media, likes, reposts, replies, views, filters, and cursor checkpoints."
