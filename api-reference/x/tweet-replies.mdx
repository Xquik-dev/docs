...
represents one reply for a single tweet. Workers can resume after the last
stored page.
...
<ResponseField name="tweets" type="object[]">
  ...
  <Expandable title="Tweet object fields">
    ...
    <ResponseField name="contentDisclosure" type="object">X can return paid partnership and AI-generated media labels here. The object can include `advertising.isPaidPromotion` and `aiGenerated.hasAiGeneratedMedia`. X may omit it.</ResponseField>
