...
Use `mode=complete` when completeness matters. It already includes direct and
conversation search. A `424 replies_incomplete` response still includes safe
partial rows. Inspect `diagnostic.recommendedFallback` before retrying.
