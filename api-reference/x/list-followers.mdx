...
description: "Retrieve followers associated with an X list with usernames, bios, verification state, profile media, follower counts, and cursor pages. See examples."
