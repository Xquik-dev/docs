---
title: "Twitter profile search & user lookup"
sidebarTitle: "Get user"
description: "Search a Twitter or X profile by username or user ID. Retrieve the bio, follower and following counts, verification status, location, and links."
api: "GET /x/users/{id}"
...
<Tip>
  See [Read Data Richness](/guides/read-data-richness) for every optional
