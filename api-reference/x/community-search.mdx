...
description: "Search tweets inside one X community by keyword. Use either supported REST path for authors, replies, reposts, likes, media, and cursor pages. See costs."
