...
keywords: ["twitter community search", "twitter search in community", "community tweets", "keyword tweet search", "community monitoring"]
---
...
Send `communityId`, `q`, and one `queryType`. Use `Latest` for recent matches.
Use `Top` for relevance-ranked matches.
