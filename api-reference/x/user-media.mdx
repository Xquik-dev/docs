  ...
  <Tab title="200 OK">
    <ResponseField name="tweets" type="object[]">
      ...
      <Expandable title="tweet object">
        ...
        <ResponseField name="author" type="object">Tweet author profile (id, username, name, followers, verified, profilePicture). Omitted if unavailable.</ResponseField>
...
<Note>
  **Related:** [User Tweets](/api-reference/x/user-tweets) · [User Likes](/api-reference/x/user-likes) · [User Mentions](/api-reference/x/user-mentions)
</Note>
