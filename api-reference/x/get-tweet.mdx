...
description: "Retrieve one tweet by numeric ID with full text, author fields, media, quote and reply context, and metrics. See examples."
api: "GET /x/tweets/{id}"
...
<Tip>
  See [Read Data Richness](/guides/read-data-richness) for every optional tweet,
