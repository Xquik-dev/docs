...
<ResponseField name="author" type="object">
  ...
  **Author object fields:**
    Author fields can include `id`, `username`, `name`, `followers`,
    `verified`, and `profilePicture` when available.
