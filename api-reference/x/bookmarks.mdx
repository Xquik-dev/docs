...
Store the connected account ID beside each row. Create each row key from its
account ID, folder ID, and tweet ID. Keep private folder names out of public logs.
