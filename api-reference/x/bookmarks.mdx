...
Store the connected account ID beside each row. Combine account ID, folder ID,
and tweet ID for a stable row key. Keep private folder names out of public logs.
