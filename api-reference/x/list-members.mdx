---
title: "Twitter list members API & profile export"
sidebarTitle: "Get list members"
description: "Retrieve X list members with usernames, display names, bios, verification state, profile media, and follower and following counts."
