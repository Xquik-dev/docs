---
title: "Twitter DM History API & Conversation Sync"
sidebarTitle: "Get DM history"
description: "Read participant-scoped X direct message history with a connected account, store private rows, and resume older pages with next_cursor. See API fields."
