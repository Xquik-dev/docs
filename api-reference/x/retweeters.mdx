...
[The tweet-replies endpoint returns the direct conversation.](/api-reference/x/tweet-replies)
...
<ResponseField name="users" type="object[]">
  ...
  **User object fields:**
    ...
    <ResponseField name="profile_bio" type="object">This object contains a structured bio and entity annotations. X may omit it.</ResponseField>
    <ResponseField name="isBlueVerified" type="boolean">X sets this flag for X Premium verification. X may omit it.</ResponseField>
    <ResponseField name="isVerified" type="boolean">This field contains normalized verification status. X may omit it.</ResponseField>
