...
keywords: ["can I see who retweeted my tweet", "see who retweeted my tweet", "get retweeters", "tweet retweeters API", "retweet users API", "users who retweeted a tweet", "Twitter retweeters API", "repost audience", "giveaway verification"]
---
...
<Info>
  Use this Twitter API to see who retweeted one public tweet. The response
  returns one user profile per visible reposting account. The canonical route
