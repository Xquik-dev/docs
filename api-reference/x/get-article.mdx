---
title: "Get X article"
description: "Retrieve one long-form X Article by tweet ID with title, body blocks, cover image, metrics, and author fields"
...
<Callout icon="coins" color="#5c3327">
  **5 credits per call** · [All plans](https://xquik.com/#pricing) from $0.00012/credit · Direct [MPP](/mpp/overview): USD 0.00075 per call
</Callout>
  ...
  <Tab title="200 OK">
    ...
    <ResponseField name="author" type="object">
      ...
      <Expandable title="author object">
        ...
        <ResponseField name="canDm" type="boolean">Whether the account accepts direct messages. Omitted if unavailable.</ResponseField>
      </Expandable>
    </ResponseField>
