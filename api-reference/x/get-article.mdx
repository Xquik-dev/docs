...
<ResponseField name="author" type="object">
  ...
  **Author object fields:**
    ...
    <ResponseField name="canDm" type="boolean">Whether the authenticated viewer can send this author a direct message. Omitted without viewer context.</ResponseField>
