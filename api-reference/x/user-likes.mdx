...
Lines rows with the liked-by user, liked tweet ID, text, tweet URL, author join
fields, engagement counts, media URLs, and cursor fields so a worker can resume
...
<Note>
  **Related:** [User Tweets](/api-reference/x/user-tweets) · [User Media](/api-reference/x/user-media) · [User Mentions](/api-reference/x/user-mentions)
</Note>
