---
title: "Get following"
description: "Retrieve the accounts one X user follows by username or numeric user ID with cursor pagination for social graph, CRM, warehouse, and agent workflows"
api: "GET /x/users/{id}/following"
keywords: ["get following", "following API", "Twitter following API", "X following API", "who a user follows", "following list", "social graph API", "CRM export", "JSON export", "X API"]
---
