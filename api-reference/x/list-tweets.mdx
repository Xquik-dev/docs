---
title: "Twitter list tweets API & timeline export"
sidebarTitle: "Get list tweets"
description: "Retrieve tweets from an X list with authors, text, replies, reposts, likes, quotes, media, timestamps, and cursor-based pagination."
