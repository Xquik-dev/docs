---
title: "Get X trends | REST API reference"
sidebarTitle: "Get X trends"
description: "Get trending topics on X by region with configurable count and WOEID filtering. Review examples, responses, and integration guidance."
api: "GET /x/trends"
