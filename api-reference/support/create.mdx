---
title: "Xquik support ticket API | create request"
sidebarTitle: "Create ticket"
description: "Open a private support ticket with a subject, message, screenshots, or videos. Save its ticket ID for replies, status updates, and downloads."
