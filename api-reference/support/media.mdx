...
description: "Upload or download private support ticket screenshots and videos with authenticated multipart requests and attachment IDs. Includes exact API examples."
...
<ResponseExample>
  ...
  ```text 206 · support/media
  <string>
  ```

  ```json 401 · support/media
  {
