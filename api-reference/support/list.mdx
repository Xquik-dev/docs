---
title: "List Xquik Support Tickets & Message Counts"
sidebarTitle: "List tickets"
description: "List support tickets with subjects, open or resolved status, message and attachment counts, creation times, and latest update timestamps. See examples."
