---
title: "Tweet draft API & saved post creation"
sidebarTitle: "Create draft"
description: "Save a tweet draft with text, an optional topic, and an optimization goal for later review, editing, or publishing without posting to X."
api: "POST /drafts"
