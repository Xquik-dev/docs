---
title: "Create draft | REST API reference"
sidebarTitle: "Create draft"
description: "Save a tweet draft for later editing or posting from any connected X account. Review examples, responses, and integration guidance."
api: "POST /drafts"
