---
title: "Get Tweet Draft Details & Saved Post Content"
sidebarTitle: "Get draft"
description: "Retrieve one tweet or thread draft by ID with text, post order, media attachments, reply target, creation time, and update time. Includes API examples."
api: "GET /drafts/{id}"
