---
title: "List tweet drafts & saved post ideas"
sidebarTitle: "List drafts"
description: "List saved tweet and thread drafts with text, media attachments, reply targets, creation times, and cursor-based pagination."
api: "GET /drafts"
