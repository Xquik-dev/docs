---
title: "Get webhook event & monitor payload"
sidebarTitle: "Get event"
description: "Retrieve one monitor event by ID with tweet text, author fields, engagement metrics, event type, timestamps, and monitor identifiers."
api: "GET /events/{id}"
...
<Note>
  **Related:** [List Events](/api-reference/events/list) &middot; [List Deliveries](/api-reference/webhooks/deliveries) &middot; [Get Monitor](/api-reference/monitors/get)
</Note>
