---
title: "Tweet Composer API, Draft Checks & Post Preview"
sidebarTitle: "Build a post draft"
description: "Generate editorial rules, refine a tweet or thread plan, and check a post draft for clarity, tone, structure, claims, and platform fit. See API fields."
api: "POST /compose"
