---
title: "List extractions | REST API reference"
sidebarTitle: "List extractions"
description: "Retrieve extraction job history with filtering and cursor-based pagination. Review examples, responses, and integration guidance."
api: "GET /extractions"
