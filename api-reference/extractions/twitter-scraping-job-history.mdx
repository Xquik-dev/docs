---
title: "Twitter extraction history & scraper jobs"
sidebarTitle: "Scraping job history"
description: "List tweet, follower, following, reply, profile, timeline, media, community, and list extraction jobs by tool, status, and cursor."
api: "GET /extractions"
...
<ResponseField name="extractions" type="object[]">
  ...
  **Extraction object properties fields:**
