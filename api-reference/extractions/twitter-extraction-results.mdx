...
<ResponseField name="results" type="object[]">
  ...
  **Result object fields.**
    ...
    <ResponseField name="tweetUrl" type="string">Canonical X post URL. Omitted for non-tweet-based extractions.</ResponseField>
    ...
    <ResponseField name="media" type="object[]">Attached media with `outputPreset=flat`. Full nested output stores it at `enrichmentData.tweet.media`.</ResponseField>
    ...
    <ResponseField name="enrichmentData" type="object">Additional profile, Tweet, media, and article metadata. Compact output omits this object. Full output keeps it nested. Flat output merges its fields into the result.</ResponseField>
