...
description: "Export tweet, follower, reply, profile, timeline, community, or list results in 7 formats, with documented CSV, XLSX, JSON, and PDF limits."
...
<Note>
  **Next steps:** [Get Extraction](/api-reference/extractions/twitter-extraction-results) to access results via the API with pagination, or [List Extractions](/api-reference/extractions/twitter-scraping-job-history) to find other extraction jobs to export.
</Note>
