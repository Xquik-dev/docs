---
title: "Create API key | REST API reference"
sidebarTitle: "Create API key"
description: "Create an API key for tweet, follower, profile, monitor, webhook, export, and X account requests. Copy the secret once and store it safely."
api: "POST /api-keys"
