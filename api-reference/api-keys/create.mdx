...
description: "Create an API key for tweet, follower, profile, monitor, webhook, export, and X account requests. Copy the secret once and store it safely. See costs."
api: "POST /api-keys"
...
<Note>
  ...
  bearer tokens cannot create additional keys.
