...
api: "GET /api-keys"
keywords: ["X API key", "Twitter API key", "API key management", "list API keys", "API key authentication", "Xquik API key"]
---
...
| Last authentication | `lastUsedAt` | Investigate stale or unexpectedly active keys. |

`lastUsedAt` is optional. Its absence means no authenticated use was recorded.
