---
title: "Xquik API key revocation & access control"
sidebarTitle: "Revoke API key"
description: "Permanently revoke an API key used for tweet, follower, profile, monitor, webhook, export, or account-action requests. Revocation is immediate."
