---
title: "Compare styles | REST API reference"
sidebarTitle: "Compare styles"
description: "Compare two cached tweet style profiles side by side. Review Compare styles parameters, examples, responses, and integration guidance."
