---
title: "Get style | REST API reference"
sidebarTitle: "Get style"
description: "Retrieve a cached tweet style profile with post text, authors, engagement metrics, and timestamps. Review examples and response fields."
api: "GET /styles/{id}"
