...
keywords: ["twitter analytics", "x analytics", "tweet analytics", "twitter tweet analytics", "twitter analytics for another account"]
---
...
Use an analyzed X username, with or without `@`, whose samples contain live
Tweet IDs. Custom styles contain local IDs that cannot produce X analytics.
...
<ParamField path="id" type="string" required>
  Analyzed X username with live Tweet IDs. A leading `@` is allowed. This is not
