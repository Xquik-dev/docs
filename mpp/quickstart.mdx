...
description: "Make an anonymous pay-per-use tweet, profile, follower, trend, or Radar request with HTTP 402, Tempo USDC, and a payment receipt. See payment examples."
