---
title: "Machine Payments Protocol for X API"
description: "Use HTTP 402 and Tempo USDC for anonymous fixed-price tweet, user, follower, trend, Radar, health, and pricing requests."
