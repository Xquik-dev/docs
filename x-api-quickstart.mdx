---
title: "Twitter API Integration for Tweet Monitors & Webhooks"
sidebarTitle: Quickstart
description: "Build a Twitter API integration with Xquik. Create an API key, authenticate a REST request, monitor tweets every 1 second, and send signed webhooks."
